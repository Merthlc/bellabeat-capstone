CREATE OR REPLACE VIEW `capstone-project-475109.Fitabase_Data.Minute_Intensities_cleaned` AS
SELECT 
    ...
    h.Intensity
FROM `capstone-project-475109.Fitabase_Data.Minute_Intensities` h

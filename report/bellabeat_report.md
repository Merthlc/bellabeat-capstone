...
├── README.md
├── report/
│   └── bellabeat_report.md        # Full analysis report (Ask → Act)
└── sql/
    ├── 00_audit_queries.sql        # Duplicate & null check queries
    ├── 01_cleaning_views.sql       # All CREATE VIEW cleaning scripts
    └── 02_analysis_queries.sql     # 6 analysis queries with conclusions
```
